# YoCustomUssdUtils
A Java library to help you verify the signature of the Yo Customer USSD Call-Out API.

Sample Code on How to use the Lib
=====================================
```
    ...
    System.out.print("Signed Data String: "+data+"\n");
    System.out.print("Sha1 Hex String: "+sha1Data+"\n");
